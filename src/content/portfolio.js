...
export const whoAmI = [
  {
    ...
    content:
    "It was 2019 when I started my Bachelor.s in Computer Science and Engineering. Why? Because everywhere I looked, people were saying the same thing: AI is the future, and you have to be a part of it. So that’s exactly what I decided to do. I started from the very basics. I dove deep into artificial intelligence, learning everything from scratch: the mathematics behind it, the underlying principles, the mechanics of how intelligent systems actually work. What began as curiosity soon turned into a career path. I eventually started my career implementing AI-based solutions for industries such as automotive and healthcare, working within large-scale service-based organizations where technology was deployed at scale. As my experience grew, my role slowly evolved beyond pure technical work. I began working on business analysis and helping organizations strategize roadmaps for company-wide AI implementation, particularly within startups. This phase of my career exposed me to the broader business side of technology—how companies decide what to build, why they build it, and how innovation is aligned with long-term business objectives. Working with and for the problems of several Fortune 100 companies gave me a deep understanding of how these giants operate. I got a closer look at the challenges they face, the systems they rely on, and the complexity behind decision-making at that level. Somewhere along this journey, I realized something important: I had fallen in love with the management and strategy side of businesses. Everything eventually pushed me further in that direction. In 2025, I joined EDHEC Business School to pursue a Master’s in Strategy, Organisation and Consulting. During this time, I had the opportunity to work with organizations such as BCG Inverto, Capgemini Invent, L’Oréal, and many others, gaining even deeper exposure to strategic problem-solving and high-level business decision-making. After all these experiences and achievements, one realization became clear to me. If you understand technology, have enough creativity to imagine possibilities, and can communicate your ideas clearly, then you should be working with, or becoming a part of, the teams that shape a company’s direction, mission, and vision. Because those are the people who truly determine where organizations go. Reaching that level is not something that happens overnight. It’s a gradual process. But every leader I have known or met shares a common trait: they are, in many ways, jack-of-all-trades. They have touched different layers of the organization, understood how each level works, and moved rapidly through them while continuously expanding their perspective. That is what I aspire to become: A good leader. AN EXPERT JACK OF ALL TRADES!"
  },
  {
    id: "about-ai",
